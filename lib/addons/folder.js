...
(function() {
  ...
  fs = require("fs");
  //增加二级目录控制
  list = function(klass, links, pathname, secdir) {
    var link;
    return ((function() {
      var i, len, results;
      results = [];
      for (i = 0, len = links.length; i < len; i++) {
        link = links[i];
        results.push("<a class='" + klass + "' href='" + secdir + (sysPath.join(pathname, link)) + "'>" + link + "</a>");
      }
      return results;
    })()).join("\n");
  };
